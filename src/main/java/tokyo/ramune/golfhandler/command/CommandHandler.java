...
public class CommandHandler implements CommandExecutor {
    ...
    public CommandHandler(@NonNull JavaPlugin plugin) {
        plugin.getCommand("golf").setExecutor(this);

        registerSubCommand(new HelpCommand());
        registerSubCommand(new GetCommand());
        registerSubCommand(new UUIDCommand());
        registerSubCommand(new MapCommand());
        registerSubCommand(new StageCommand());
    }
