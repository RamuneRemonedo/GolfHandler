...
public class MySQL {
    ...
    public static void connect(boolean message) {
        String host = GolfPlugin.getConfiguration().getConfig().getString("config.database.host", "127.0.0.1");
        String user = GolfPlugin.getConfiguration().getConfig().getString("config.database.user", "golf");
        String password = GolfPlugin.getConfiguration().getConfig().getString("config.database.password", "password");
        String database = GolfPlugin.getConfiguration().getConfig().getString("config.database.database", "golf");
        String port = GolfPlugin.getConfiguration().getConfig().getString("config.database.port", "3306");
